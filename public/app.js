...
app.controller('mainController', ['$http', '$scope', '$filter', function($http, $scope, $filter) {
  ...
  this.darkskyurl = 'https://api.darksky.net/forecast/a9d279d680c92a498e132e03592ee873/' + String(this.latitude) + ',' + String(this.longitude)

  this.getWeather = () => {
    $http({
      method: 'GET',
      url: this.darkskyurl
    }).then( response => console.log(this.darkskyurl, "url", response, "response") );
  }
